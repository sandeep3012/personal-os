/// Technology-neutral SQL execution contract used by the Notes DAO layer.
///
/// Mirrors Goals' `IGoalDatabaseExecutor` exactly — a per-feature
/// persistence-leaf interface, not a shared cross-feature abstraction.
abstract interface class INoteDatabaseExecutor {
