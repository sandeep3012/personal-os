...
/// Records an income Transaction and persists it.
///
...
final class AddIncomeUseCase
    implements AsyncUseCase<AddIncomeInput, Transaction> {
  AddIncomeUseCase({
  ...
  @override
  Future<Result<Transaction>> execute(AddIncomeInput input) async {
    try {
