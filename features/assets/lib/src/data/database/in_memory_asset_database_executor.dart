...
/// [IAssetDatabaseExecutor], built specifically to understand the exact SQL
/// shapes [AssetDao] emits — mirrors Notes' `InMemoryNoteDatabaseExecutor`
/// exactly, scoped to Assets's single table.
///
/// This is the Assets feature's default persistence until a concrete
...
/// Assets feature is fully usable — data simply does not survive an app
/// restart on its own (see `FileBackedAssetDatabaseExecutor` for that).
final class InMemoryAssetDatabaseExecutor implements IAssetDatabaseExecutor {
  final Map<String, List<Map<String, Object?>>> _tables = {
    AssetsSchema.assetsTable: <Map<String, Object?>>[],
  };
  ...
  // ── Snapshot / restore (backs InMemoryAssetTransactionRunner) ────────────
  ...
  Future<int> execute(String sql, [List<Object?> arguments = const []]) async {
    ...
    throw UnsupportedError('InMemoryAssetDatabaseExecutor: unrecognized '
  ...
  int _insert(String sql, List<Object?> args) {
    ...
    final table = _tables[AssetsSchema.assetsTable]!;
